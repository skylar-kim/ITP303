...
if (
	isset($_GET["release_date_from"]) && !empty($_GET["release_date_from"])
	&& isset($_GET["release_date_to"]) && !empty($_GET["release_date_to"])
) {
	$sql = $sql . " AND dvd_titles.release_date between '" . $_GET["release_date_from"] . "' and '" . $_GET["release_date_to"] . "'";
} else if (
	isset($_GET["release_date_from"]) && !empty($_GET["release_date_from"])
	&& empty($_GET["release_date_to"])
) {
	$sql = $sql . " AND dvd_titles.release_date > " . $_GET["release_date_from"];
} else if (
	isset($_GET["release_date_to"]) && !empty($_GET["release_date_to"])
	&& empty($_GET["release_date_from"])
) {
