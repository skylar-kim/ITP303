...
$sql = "SELECT tracks.name AS track, genres.name AS genre, media_types.name AS media_type, tracks.track_id
				FROM tracks
				LEFT JOIN genres
...
<?php while ( $row = $results->fetch_assoc() ) : ?>
	<tr>
		<td><a href="details.php?track_id=<?php echo $row['track_id']; ?>"><?php echo $row['track']; ?></a></td>
