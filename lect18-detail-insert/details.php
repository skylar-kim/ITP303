...
$sql = "SELECT tracks.name AS track, artists.name AS artist, tracks.composer, albums.title AS album, genres.name AS genre, tracks.milliseconds, tracks.bytes, tracks.unit_price
FROM tracks
LEFT JOIN albums
