<?php
    ...
    */
    ...
    // 2. Determine URL
    $url = "https://api.yelp.com/v3/businesses/search?" . http_build_query($data);
    //echo $url;
    ...
    // 4. Parse Response
    // execute curl request and assign it back to a resposne
    $response = curl_exec($curl);
    //echo $response;
    $response = json_decode($response, true);
    ...
    // turns a JSON array and makes it a string
